        ...
        <>
            ...
            <View style={{ paddingTop: responsiveWidth(3), justifyContent: "center", alignItems: "center" }}>
                ...
                <View style={{ flexDirection: 'row', width: responsiveWidth(90), justifyContent: "space-between", alignItems: "center" }}>
                    <StoryUsers images={SNOWDAY_ICON} text="Snow day" mainbgColor="#395E66" backgroundColor="#497780" />
                    <StoryUsers images={HEATWAVE_ICON} text="HeatWave" mainbgColor="#395E66" backgroundColor="#497780" />
                    <StoryUsers images={CYCLONE_ICON} text="Cyclone" mainbgColor="#395E66" backgroundColor="#497780" />
                </View>
                <View style={{ paddingTop: responsiveWidth(3), paddingBottom: moderateVerticalScale(12), flexDirection: 'row', width: responsiveWidth(90), justifyContent: "space-between", alignItems: "center" }}>
                    <StoryUsers images={HURRICANE_ICON} text="Cyclone" mainbgColor="#395E66" backgroundColor="#497780" />
                    <StoryUsers images={HAIL_ICON} text="hail" mainbgColor="#395E66" backgroundColor="#497780" />
                    <StoryUsers images={ECLIPSE_ICON} text="Eclipse" mainbgColor="#395E66" backgroundColor="#497780" />
                </View>
