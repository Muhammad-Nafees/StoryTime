        ...
        <>
            ...
            <View style={{ paddingTop: responsiveWidth(3), justifyContent: "center", alignItems: "center" }}>
                <View style={{ flexDirection: 'row', width: responsiveWidth(90), justifyContent: "space-between", alignItems: "center" }}>
                    <StoryUsers images={PRINTER_ICON} text="Printer" mainbgColor="#395E66" backgroundColor="#497780" />
                    <StoryUsers images={MEETING_ICON} text="Meeting Room" mainbgColor="#395E66" backgroundColor="#497780" />
                    <StoryUsers images={BULLETIN_ICON} text="Bulletin Board" mainbgColor="#395E66" backgroundColor="#497780" />
                </View>
                <View style={{ paddingTop: responsiveWidth(3), paddingBottom: moderateVerticalScale(12), flexDirection: 'row', width: responsiveWidth(90), justifyContent: "space-between", alignItems: "center" }}>
                    <StoryUsers images={POST_IT_ICON} text="Post It" mainbgColor="#395E66" backgroundColor="#497780" />
                    <StoryUsers images={PANTRY_ICON} text="Pantry" mainbgColor="#395E66" backgroundColor="#497780" />
                    <StoryUsers images={WORK_SPACE_ICON} text="Work Space" mainbgColor="#395E66" backgroundColor="#497780" />
                </View>
                <View style={{ paddingBottom: moderateVerticalScale(12), flexDirection: 'row', width: responsiveWidth(90), justifyContent: "space-between", alignItems: "center" }}>
                    <StoryUsers images={CHAIR_ICON} text="Office Chair " mainbgColor="#395E66" backgroundColor="#497780" />
                    <StoryUsers images={STAPLER_ICON} text="Stapler" mainbgColor="#395E66" backgroundColor="#497780" />
