        ...
        <>
            ...
            <View style={{ paddingTop: responsiveWidth(3), justifyContent: "center", alignItems: "center" }}>
                <View style={{ flexDirection: 'row', width: responsiveWidth(90), justifyContent: "space-between", alignItems: "center" }}>
                    <StoryUsers images={SURF_ICON} text="Surf" mainbgColor="#395E66" backgroundColor="#497780" />
                    <StoryUsers images={BIKE_ICON} text="Bike" mainbgColor="#395E66" backgroundColor="#497780" />
                    <StoryUsers images={CAR_ICON} text="Car" mainbgColor="#395E66" backgroundColor="#497780" />
                </View>
                <View style={{ paddingTop: responsiveWidth(3), paddingBottom: moderateVerticalScale(12), flexDirection: 'row', width: responsiveWidth(90), justifyContent: "space-between", alignItems: "center" }}>
                    <StoryUsers images={MOTORBIKE_ICON} text="Motorbike" mainbgColor="#395E66" backgroundColor="#497780" />
                    <StoryUsers images={AMBULANCE_ICON} text="Ambulance" mainbgColor="#395E66" backgroundColor="#497780" />
                    <StoryUsers images={SCOOTER_ICON} text="Scooter" mainbgColor="#395E66" backgroundColor="#497780" />
