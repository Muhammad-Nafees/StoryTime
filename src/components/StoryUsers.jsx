...
const StoryUsers = ({ images, text, backgroundColor, mainbgColor }) => {
    ...
    return (
        <View style={{ backgroundColor: mainbgColor, width: responsiveWidth(29), borderRadius: 10, height: responsiveHeight(18.5), alignItems: "center", }}>
            <View style={{ marginVertical: moderateVerticalScale(10), borderRadius: 10, width: responsiveWidth(25), height: responsiveHeight(11), backgroundColor: backgroundColor, justifyContent: "center", alignItems: "center" }}>
