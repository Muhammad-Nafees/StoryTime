            ...
            <View>
                ...
                <View style={styles.container}>
                    <View style={{ width: responsiveWidth(90), }}>
                        ...
                        <VoiceToText onPress={() => navigation.navigate(SECONDUSER_NEXT_PLAY)} text="Done" BackgroundImage={FULL_BORDER_FRAME} InnerImage={NEXT_PLAYER_IMG} bgColor={PrimaryColor} innerColor="#4B7A84" />
                    </View>
                </View>
            </View>
        </ImageBackground>
...
export default FourthUserStory;
