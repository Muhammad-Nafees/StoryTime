...
const CoutinueAndNextPlayer = () => {
    ...
    const { THIRD_USER } = NavigationsString;
            ...
            <View>
                ...
                <View style={styles.container}>
                    <View style={{ width: responsiveWidth(90), }}>
                        <VoiceToText text="Continue" BackgroundImage={FULL_BORDER_FRAME} InnerImage={EXTEND_STORY_IMG} bgColor={TextColorGreen} innerColor="#EA89A7" />
                        <VoiceToText onPress={() => navigation.navigate(THIRD_USER)} text="Next Player" BackgroundImage={FULL_BORDER_FRAME} InnerImage={NEXT_PLAYER_IMG} bgColor={PrimaryColor} innerColor="#4B7A84" />
                    </View>
                </View>
            </View>
        </ImageBackground>
...
export default CoutinueAndNextPlayer;
