...
const ThirdExtendStory = () => {
    ...
    const { FOURTH_USER } = NavigationsString;
            ...
            <View>
                ...
                <View style={styles.container}>
                    <View style={{ width: responsiveWidth(90), }}>
                        ...
                        <VoiceToText onPress={() => navigation.navigate(FOURTH_USER)} text="Next Player" BackgroundImage={FULL_BORDER_FRAME} InnerImage={NEXT_PLAYER_IMG} bgColor={PrimaryColor} innerColor="#4B7A84" />
                    </View>
                </View>
            </View>
        </ImageBackground>
...
export default ThirdExtendStory;
