...
import { setFriendId, setIsPublicOrPrivateMode, setResponseUsersProfile } from '../../../../store/slices/addplayers/addPlayersSlice';
...
const Profile = ({ route }) => {
  ...
  const [responseUserProfile, setResponseUserProfile] = useState(null);
