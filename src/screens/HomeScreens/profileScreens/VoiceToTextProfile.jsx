            ...
            <SafeAreaView>
                <ScrollView>
                    <View style={{}}>
                        ...
                        <View style={{ justifyContent: "center", alignItems: "center", paddingBottom: responsiveWidth(20) }}>
                            <SettingButton onPress={() => navigation.navigate("profileStack", {
                                screen: "TranscriptVoice"
