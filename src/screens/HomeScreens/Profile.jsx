        ...
        <ImageBackground style={styles.container} source={SPLASH_SCREEN_IMAGE}>
            <ScrollView>
                ...
                <View style={{ paddingTop: responsiveWidth(5), justifyContent: "center", alignItems: "center" }}>
                    ...
                    <AddFriendUsers profileimage={SECOND_PROFILE} text="@nolanjames" />
                    <AddFriendUsers profileimage={THIRD_PROFILE} text="@christine02" />
                    <AddFriendUsers profileimage={FOURTH_PROFILE} text="@adamadam" />
                    <AddFriendUsers profileimage={FIFTH_PROFILE} text="@markyyy" />
                    <AddFriendUsers profileimage={SIXTH_PROFILE} text="@jeniffer.p" />
                </View>
