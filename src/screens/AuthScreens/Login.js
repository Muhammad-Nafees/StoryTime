...
const Login = () => {
    ...
    const onchangeValuePassword = (text) => {
        console.log("text--", text)
    }
    ...
    return (
        ...
        <Formik
            ...
            onSubmit={(values, { setSubmitting }) => {
                ...
                // If the form is valid, dispatch the login action
                dispatch(login(values));

                // Reset the form
                setSubmitting(false);
            }}
        >{({ values, errors, setFieldTouched, handleChange, isValid, touched, handleSubmit }) => (
            ...
            <View style={styles.container}>
                ...
                <View>
                    ...
                    <TextInputField value={values.username} onChangeText={handleChange("username")} placeholderText="Type here" />
                    <View style={{ width: "90%", marginLeft: 'auto' }}>
                        {
                            errors.username && (
                    ...
                    <TextInputField value={values.password} onChangeText={handleChange("password")} onPress={toggleShowPassword} showPassword={showPassword} placeholderText="Type here" type="password" />
                    <View style={{ width: "90%", marginLeft: 'auto' }}>
                        {
                            errors.password && (
