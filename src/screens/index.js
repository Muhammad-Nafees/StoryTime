...
export {default as RegisterPassword} from './AuthScreens/RegisterPassword';
export {default as OtpForget} from './AuthScreens/forgetscreens/OtpForget';
export {default as PopUpStart} from './AuthScreens/SplashScreens/PopUpStart';
export {default as ForgetEmail} from './AuthScreens/forgetscreens/ForgetEmail';
export {default as SplashScreen} from './AuthScreens/SplashScreens/SplashScreen';
export {default as RegisterUserInformation} from './AuthScreens/RegisterUserInformation';
